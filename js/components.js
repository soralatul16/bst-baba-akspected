      ...
      <div class="tp-body">
        ...
        <div class="tp-section">
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,280px),1fr));gap:16px">
            ...
            <div style="background:var(--bg);border:1px solid var(--border);border-radius:10px;padding:16px">
              <h4 style="font-size:0.82rem;font-weight:700;margin-bottom:8px">Vartika Lakhani (100/100)</h4>
              <p style="font-size:0.72rem;color:var(--text-muted);margin-bottom:10px">Shown in testimonials section.</p>
              <img id="imgPreview_vartika_photo" style="width:60px;height:60px;border-radius:50%;object-fit:cover;border:2px solid var(--border);margin-bottom:10px;display:none" alt="Vartika">
              <div>
                <input type="file" id="imgFile_vartika_photo" accept="image/*" style="font-size:0.75rem;margin-bottom:8px">
                <button class="modal-btn" style="max-width:150px;font-size:0.75rem;padding:6px 14px" onclick="uploadSiteImage('vartika_photo',document.getElementById('imgFile_vartika_photo').files[0],document.getElementById('imgStatus_vartika_photo'))">Upload</button>
              </div>
